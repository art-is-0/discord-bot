...
class coin_flip(commands.Cog):
    ...
    async def coin_flip(self, interraction: discord.Interaction, which_side:str='heads'):
        lst = ['heads', 'tails']
...
#     await client.add_cog(coin_flip(client), guilds=[discord.Object(id=831996983027433532)])
