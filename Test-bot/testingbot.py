...
async def test(interaction: discord.Interaction):
    ...
    # message = ''
    # async def embed(title, description, field):
    ...
    #     embeded.add_field(name=field)

    #     return embeded
    message = f'Something\n {print_cards(dealers_cards, False)} \nSomething\n'
    await interaction.channel.send(message, delete_after=10)

    # title = 'Something\n'
    # description = print_cards(dealers_cards, False)
    # field = f'\nSomething\n'
    # embed = discord.Embed(
    #     colour=discord.Colour.dark_gold(),
    #     description=description,
